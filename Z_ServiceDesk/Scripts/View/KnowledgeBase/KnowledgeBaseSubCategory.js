            ...
            $("#tblApproveSolution").DataTable({
                ...
                columns: [
                    ...
                    { data: 'name' },
                    {
                        ...
                        bSortable: false,
                        render: function (solution_id_pk) {
                            return '<a href="#' + solution_id_pk + '" title="Click here to view more details" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a>';  // <button class="btn btn-xs btn-success grid-buttons btnedit" name="' + catogory_id_pk + '" style="margin-right:5px;"><i class="fa fa-edit icon-ser"></i></button>
                        }
                    }
                ],
                dom: 'Bfrtip',
