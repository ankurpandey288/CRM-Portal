...
function GetAutoClosedTime() {
    $.ajax({
        ...
        url: 'http://playmediahouse.com/api/api/Ticket/GetAutoClosedTime',
        dataType: "json",
...
function GetAutoClosedTimeList() {
    $.ajax({
        type: "Get",
        contentType: "application/json; charset=utf-8",
        url: 'http://playmediahouse.com/api/api/Commonapi/GetAutoClosedTimeList',
        dataType: "json",
        success: function (data) {
            var table;
...
function UpdateAutoCloseTime() {
    ...
    $.ajax({
        ...
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        url: 'http://playmediahouse.com/api/api/Ticket/UpdateAutoCloseTime', 
        success: function (data) {
            if (data.status_id == 1) {
