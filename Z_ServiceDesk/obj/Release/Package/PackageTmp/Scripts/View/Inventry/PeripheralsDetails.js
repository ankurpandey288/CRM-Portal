$(document).ready(function () {
    ...
    GetPeripheralComponent($.session.get("peripherals_id_pk"));
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status_id != 0) {
                ...
                $("#ClrPeripherals").find("textarea").val("");
...
function InsPeripheralComponent() {
    var parm = {
        "peripherals_id_pk": $.session.get("peripherals_id_pk"), 
    ...
    $.ajax({
        ...
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        url: 'http://playmediahouse.com/api/api/Peripherals/InsPeripheralComponent',
        success: function (data) {
...
//Get Peripherals Components
function GetPeripheralComponent(peripherals_id) {
    var parm = {
        'peripherals_id_pk': peripherals_id
    };
    var josnstr = JSON.stringify(parm);
    $.ajax({
        type: "Post",
        url: 'http://playmediahouse.com/api/api/Peripherals/GetPeripheralComponent',
        contentType: "application/json; charset=utf-8",
        data: josnstr,
        dataType: "json",
        success: function (data) {
            ...
            $("#tblAssetComponents").DataTable({
                ...
                columns: [
                    {
                        data: 'periph_comp_id_pk',
                        sWidth: '2px',
                        sClass: "view",
                        bSortable: false,
                        render: function (periph_comp_id_pk) {
                            return '<input id="checkbox0" class="cb-element checkbox tktcbk" name="' + periph_comp_id_pk + '" type="checkbox">';  // <button class="btn btn-xs btn-success grid-buttons btnedit" name="' + catogory_id_pk + '" style="margin-right:5px;"><i class="fa fa-edit icon-ser"></i></button>
                        }
                    },
                    { data: 'periph_comp_id_pk' },
                    { data: 'serial_number' },
